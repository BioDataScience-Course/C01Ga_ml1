...
> Complétez ce chink afin de Diviser ce jeu de donnée en un set d'apprentissage et en un set de test. Utilisez 7/10 des observations pour votre set d'apprentissage. Commentez ce chunk en 3 lignes maximum. 
...
> Phase 3 : Déployez votre classifieur.  Importez les données `deploy_set.csv`. Prédisez les classes da la variable genre.
